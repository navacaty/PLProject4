            ...
            if (f instanceof Function) {
                ...
                for (var i = 0; i < l.length; i++) {
                    ...
                    n = n.next;
                                        ...
                                        ////iterator method using closure////
        f.iterator = function() {
            var current_node = l.head;

            return function getNextData() {
                var next_node_data = current_node.next.data;
...
document.writeln("<BR>");
                                ...
                                //create, iterate, and then print list "l5"//
//create list "l5"
var l5 = new list();
l5.cons('s');
l5.cons('t');
...
//set var z to recieve iterator function
var z = l5.iterator();
//print iterated list
document.writeln("<BR>l5 iterated: ");
while (l5.length() > 0) {
    document.writeln(z() + ", ");
}
